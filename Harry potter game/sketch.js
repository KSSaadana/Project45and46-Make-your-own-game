...
//  sword = createSprite(harry.x+500,harry.y);
...
if(score===1){
  text("Ron is released!!!",width-400, 45);
}
if(score===2){
  text("Hermione is released!!!",width-400, 45);
}
if(score===3){
  text("Luna is released!!!",width-400, 45);
}
if(score===4){
  text("Neville is released!!!",width-400, 45);
}
if(score===5){
  text("Ginny is released!!!",width-400, 45);
}
if(score===6){
  text("James Potter is released!!!",width-400, 45);
}
if(score===7){
  text("Lily potter is released!!!",width-400, 45);
}
